...
type BannerProps = { /* message: string, */ display: boolean, isError?: boolean, children: string } & React.HTMLAttributes<HTMLDivElement>;
...
export default function Banner(props: BannerProps): JSX.Element {
  ...
  return (
    <div {...divProps} className={classNames(
      "py-2 px-3 my-3 rounded align-items-center",
